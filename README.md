...
* **Tipos de Aprendizaje:** **Aprendizaje supervisado** y **no supervisado**.
* **Distinciones:** Diferencias entre Aprendizaje Automático, Aprendizaje Profundo, Minería de Datos e Inteligencia Artificial.

### 2. Preprocesamiento, Optimización y Evaluación
* **Visualización y Normalización:** Carga de bases de datos. **Visualización** en espacios n-dimensionales. **Normalización de los datos**. Atributos nominales y numéricos.
* **Performance:** Conjuntos de **entrenamiento y evaluación**. Matriz de confusión. **Precision** y **Recall**. **F-measure**.

### 3. Aprendizaje Supervisado y Redes Neuronales
* **Regresión:** Regresión Lineal (Método analítico vs. **Métodos iterativos**). **Descenso del gradiente**.
